...
Original file is located at
    https://colab.research.google.com/drive/1n8Sp7AhriY8HwBPaQkfRzvWenEiZzo80
"""
...
A: Double check the Data Update tab. Column B contains the campaign name. Compare it to the USA tab using CTRL+F. Usually a small space or dash makes the difference. Also remove dollar symbols via CTRL+H (Find: $, Replace: empty).
...
**Tokens go ONLY into Railway — never GitHub:**

Once deployed on Railway, go to your project → **Variables** tab and add:
```
